...
| `04-comprehensive-workflow` | Use a neutral workflow map after learning the Ledger validation layers. | Wire one intent lane into a real app surface. | Combine identity, approval, optional wallet proof, local/off-chain state, and feedback evidence. |
